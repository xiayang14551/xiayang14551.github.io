 ...
 * @LastEditTime: 2020-10-23 10:57:25
 -->
...
<head>
  ...
  <script async src="https://www.googletagmanager.com/gtag/js?id=UA-45384067-2"></script>
  <script>
      ...
      <td>
        ...
        <table width="100%" align="center" border="0" cellpadding="12" style="table-layout:fixed;">
          ...
          <tr>
            ...
            <td valign="center">
                Our USENIX Security'21 paper got accepted! <br>
        ...
        <table width="100%" align="center" border="0" cellpadding="12" style="table-layout:fixed;">
          ...
          <tr>
            <td valign="center">
                <papertitle>[USENIX Security'21]</papertitle>
            </td>
            <td valign="center">
                <papertitle>CADE: Detecting and Explaining Concept Drift Samples for Security Applications</papertitle>
                <br>
                <span class="underline">Limin Yang</span>,
                Wenbo Guo, Qingying Hao, Arridhana Ciptadi, Ali Ahmadzadeh, Xinyu Xing, Gang Wang
                <br>
                <a href="https://github.com/whyisyoung/CADE">Code</a> /
                <span class="artifact">Artifact Evaluated</span>
                <br>
                <span class="tldr">TL;DR:  Contrastive learning can help detect drifting samples from previously unseen classes and distance-based explanation can find out why such drifting samples are different from existing classes. </span>
            </td>
          </tr>
          <tr>
            <td valign="center">
                <papertitle>[USENIX Security'20]</papertitle>
            </td>
            <td valign="center">
                ...
                <!-- <a href="https://sfzhu93.github.io/projects/vt/paper-list.html">Papers used VirusTotal</a> / -->
                <span class="artifact">Artifact Evaluated</span>
                <br>
                <span class="tldr">TL;DR:  How to aggregate VirusTotal labels more properly? </span>
            </td>
          </tr>
          <tr>
            <td valign="center">
            ...
            <td valign="center">
                ...
                <br>
                <span class="tldr">TL;DR: Verify that replay attack and SQL injection are feasible in Amazon Alexa / Google Home apps. </span>
            </td>
          </tr>
          <tr>
            <td valign="center">
                <papertitle>[IMC'19]</papertitle>
            </td>
            <td valign="center">
                ...
                <br>
                <span class="tldr">TL;DR: Control simple phishing sites to see how bad and inconsistent of the URL detection provided by VirusTotal and security vendors' own APIs. </span>
            </td>
          </tr>
          <tr>
            <td valign="center">
                <papertitle>[USENIX Security'18]</papertitle>
            </td>
            <td valign="center">
                ...
                <br>
                <span class="tldr">TL;DR: Provide quantitive evidence on the
                  prevalence of missing information in vulnerability reports and low reproducibility by manually reproduce 368 memory corruption bugs. </span>
            </td>
          </tr>
          <tr>
            <td valign="center">
            ...
            <td valign="center">
                ...
                <br>
                <span class="tldr">TL;DR: Use metadata and heuristics to predict whether a git commit introduced a vulnerability. </span>
            </td>
          </tr>
          <tr>
            <td valign="center">
            ...
            <td valign="center">
                ...
                <br>
                <span class="tldr">TL;DR: Who used the WeChat "People Nearby" feature more often? </span>
            </td>
          </tr>
        </table>
        <!-- Publications End -->
        ...
        <table width="100%" align="center" border="0" cellpadding="12" style="table-layout:fixed;">
          ...
          <tr>
            <td valign="center">
              <a href="https://www.ist.psu.edu/"><span>Penn State</span></a>
            </td>
            <td valign="center">
          ...
          <tr>
            <td valign="center">
                <a href="https://www.xueba100.com/"><span>Xueba Jun</span></a>
            </td>
            <td valign="center">
          ...
          <tr>
            <td valign="center">
                <a href="http://english.pku.edu.cn/"><span>Peking University</
                  span></a>
            </td>
            <td valign="center">
        ...
        <table width="100%" align="center" border="0" cellpadding="12" style="table-layout:fixed;">
          ...
          <tr>
            ...
            <td>
                <span> ECNU Graduate Student Overseas Research Scholarship</span>
            </td>
          </tr>
          <tr>
            <td valign="center">
            ...
            <td>
                <span>ECNU Top-notch Innovative Personnel Training Plan</span>
            </td>
          </tr>
        </table>
        <!-- Awards End -->
        ...
        <table width="100%" align="center" border="0" cellpadding="12" style="table-layout:fixed;">
          ...
          <tr>
            ...
            <td>
                <span>CS-4264 Principles of Computer Security</span>,
          ...
          <tr>
            ...
            <td>
                <span>CS-3114 Data Structures and Algorithms</span>,
                Virginia Tech, Teaching Assistant
            </td>
          </tr>
        </table>
        <!-- Teaching End -->
        <br>
        <table width="100%" align="center" border="0" cellpadding="12" style="table-layout:fixed; color: #888;">
          <colgroup>
                <col span="1" style="width: 23%;">
                <col span="1" style="width: 77%;">
          </colgroup>
          <tr>
            ...
            <td>
                I'm also a minimalism photographer: <a href="http://whyisyoung.com" target="_blank">whyisyoung.com</a>
            </td>
          </tr>
        </table>
